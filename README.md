...
- Every dropdown in the app — sort, filters, channel type, HTTP method — opens the same custom-themed listbox, not a native browser popup that breaks from the app's palette

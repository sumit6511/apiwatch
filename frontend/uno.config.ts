...
export default defineConfig({
  ...
  shortcuts: {
    ...
    "card-interactive":
      "card-base transition hover:-translate-y-0.5 hover:border-accent/40 hover:bg-surface2 hover:shadow-lg",
    ...
    "btn-primary": "btn-base bg-accent text-bg hover:opacity-90 hover:shadow-lg hover:shadow-accent/20",
